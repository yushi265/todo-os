...
function ThemeSettingsModal({
  ...
  return (
    <ModalFrame
      ...
      overlayClassName="fixed inset-0 z-10 flex items-end justify-center bg-black/50 p-4 backdrop-blur-sm sm:items-center"
      panelClassName="w-full max-w-lg animate-[modal-in_0.2s_ease-out] rounded-[22px] bg-card p-5 shadow-[0_24px_70px_rgba(0,0,0,0.28)] sm:p-6"
    >
      <div className="mb-5 flex items-center justify-between">
        <h2 className="text-lg font-semibold text-text-primary">テーマ設定</h2>
        <Button
          variant="ghost"
          size="icon"
          ref={closeButtonRef}
